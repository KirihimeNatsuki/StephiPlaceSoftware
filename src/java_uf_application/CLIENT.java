...
public class CLIENT {
    ...
    public boolean addClient(String prenom, String nom, String tel, String email, String password, int role, Timestamp created_at, Timestamp updated_at){
    ...
    //Fonction pour modifier les infos d'un client
    public boolean modifierClient(int id, String prenom, String nom, String tel, String email, int role, Timestamp updated_at){
        PreparedStatement st;
        ResultSet rs;
    ...
    //Fonction qui affiche la liste de tous les clients de l'agent connecté de la BDD
